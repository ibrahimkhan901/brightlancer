    ...
    return (
        <div className=''>
            ...
            <div className="   h-[140vh] sm:min-h-[120vh] w-full overflow-x-hidden p-5 relative ">
                ...
                <div className="h-max w-full bg-transparent flex flex-col items-center justify-center z-[999] absolute top-0 right-0 ">




                    <h1 className='text-2xl md:text-3xl lg:text-4xl text-zinc-100 mt-10 '>How to Sell on the TikTok Shop</h1>




                    <div className="h-max w-full text-xl sm:text-2xl md:text-3xl text-zinc-100 mt-10 flex justify-center">
                        <h1 className='h-max w-max sm:px-10 p-3 border-1 border-zinc-500 bg-amber-500'>Starting From</h1>
                        <h1 className='h-max w-max sm:px-10 p-3 border-1 border-r-zinc-500 '>May, 10, 2025</h1>
                    </div>
                    ...
                    <h1 className='h-max w-max px-10 p-2 text-orange-300 text-4xl'>24,500 PKR</h1>
