...
const ContactSocialLinks = () => {
    ...
    function handleFacebookGotoBtnClick(){
        try{
            ...
            throw new Error("Facebook link is not open", err)
        }
    }
    ...
    return (
        <div className='min-h-[20vh] w-full overflow-x-hidden p-10'>



            <h1 className='h-max w-max text-2xl md:text-4xl font-bold text-zinc-900 underline '>Social Media </h1>
